...
//                surname = data.getStringExtra("loggedSurname");
    ...
    public void myMeals(View view){ startActivityForResult(new Intent(this,MyMealsView.class),1); }
    public void myOrders(View view){ startActivityForResult(new Intent(this,MyOrdersView.class),1); }
